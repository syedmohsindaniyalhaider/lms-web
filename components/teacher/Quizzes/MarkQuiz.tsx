                    ...
                    <div className=''>
                        <div className='shadow-lg  bg-white border-solid rounded-[8px] border-[1.5px]'>
                            ...
                            <div className=''>
                                ...
                                <div className=' bg-[#F5F5F5]   md:pl-[10px] md:pr-[10px] md:pt-[5px] md:pb-[5px] lg:pl-[14px] '>
                    ...
                    <h1 className="text-white text-[16px]">
                      <strong>Score:</strong> Yet to determine
                                ...
                                <div className='my-6 mx-4'>
                                    ...
                                    >
                                        <span
                                            // onClick={() => dispatch(teacherReviewProject(ele))}
