...
function NotCompletedCalendar(props: any) {
    const { id, classStatus, classes, date } = props
    return (
        <>
            {/* <div className={` ${props.third ? "" : "hidden"}`}> */}
            {/* {(props.first) ? ( */}

            <div className='grid md:grid-cols-8 lg:grid-cols-9 gap-4 p-4'>
...
export default NotCompletedCalendar
