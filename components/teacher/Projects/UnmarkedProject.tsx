...
const UnmarkedProjects = ({ projects }: any) => {
    const dispatch = useAppDispatch()
    const studentUnmarkedProjects = projects?.filter(
        (ele: any) => ele.checked === false
    )

    return (
        <>
            {studentUnmarkedProjects?.map((ele: any) => {
                return (
                    <>
...
export default UnmarkedProjects
