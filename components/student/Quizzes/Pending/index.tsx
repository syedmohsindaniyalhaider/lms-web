...
const PendingQuizzes = ({ status, quizzes }: any) => {
    return (
        <Grid item sm={6} md={4}>
            <div className=' bg-white border-solid rounded-[8px] border-[1.5px] border-[#D9D9D9]'>
                <p className='absolute z-10  font-semibold bg-[#FEE5E3] md:w-[82px] md:h-[26px] md:text-[14px] lg:h-[40px] lg:text-[20px] md:pt-[5px] lg:w-[132px] lg:p-2 text-center text-[#F94F46] rounded-tl-md rounded-br-md -mt-[2px] -ml-[2px]'>
                ...
                <div className='py-2'>
                    ...
                    <button className='my-2 ml-3 bg-[#F0A901] px-[8px] md:py-[5px]  rounded-[8px] text-white relative group overflow-hidden'>
                        <span className='relative font-author  md:text-[15px] lg:text-[20px]  z-40'>
                            <Link
                                href={`/student/classes/${quizzes?.classId}?t=q`}
                            >
                                START QUIZ
                            </Link>
                        </span>
