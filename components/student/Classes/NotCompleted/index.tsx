...
const NotCompletedClasses = (props: any) => {
    const {
        classId,
        classes,
        day,
            ...
            {classes?.length > 0 ? (
                classes?.map((item: any) => (
                  ...
                  {item?.classStatus === "pending" && (
                    <>
                      <h3 className="md:text-[20px] md:font-[600] lg:text-[24px]">
                        {moment(item?.date, "DD/MM/YYYY").format("Do MMM")}
                      </h3>
                                ...
                                <div className='flex justify-between items-center gap-3 py-2'>
                                    <div className='md:text-[14px] md:font-[400] lg:text-[22px] lg:font-[400]'>
                                        ...
                                        <span className=' underline pl-1 text-[#F0A901]'>
                                            <Link
                                                href={`/student/classes/${classes?.classId}?t=c`}
                                            >
                                                View Details
                                            </Link>
                                        </span>
...
export default NotCompletedClasses
