...
const SampleNextArrow = (props: any) => {
    const { onClick } = props
    return (
        <div className='w-[300px] h-[300px] pt-[44px]'>
            <Image
...
const Calendar = () => {
    const { classes: studentClasses } = useSelector((state: RootState) => {
    ...
    const dates = allStudentClasses?.map((i: any) => i.classes?.date)
    ...
    useEffect(() => {
        ...
        const allClassesOfStudents = studentClasses?.map(
            (item: any) => item?.classes
        )
        setAllStudentClasses(allClassesOfStudents?.flat(Infinity))
    }, [studentClasses])
        ...
        <>
            <div>
                <div className='bg-white ml-3 px-4 py-2  rounded-full flex justify-between w-[200px]'>
                    ...
                    <div>
                        <h1 className='md:text-[15px] lg:text-[20px] font-[494] text-[#000000] font-author'>
                ...
                {calendar?.map((week: any, index: any) =>
                    week?.map((day: any, idx: any) =>
                        popup === day?.format('YYYY-MM-DD') &&
                        dates?.includes(day?.format('YYYY-MM-DD')) ? (
                            allStudentClasses?.map((i: any, indx: any) =>
                                i.classes?.date?.includes(
                                    day.format('YYYY-MM-DD')
                                ) ? (
                          ...
                          !dates?.includes(day.format('YYYY-MM-DD')) ? (
                            <div className='-mt-[100px] '>
                                <div className='w-full h-[35px] bg-[#E1E6FA] mt-[] '></div>
                                <div className='w-full h-[35px] bg-[#CDD6F6] mt-[] '></div>
                                <div className='w-full h-[35px] bg-[#A4B5EF] mt-[] '></div>
                            </div>
                        ) : (
                            ''
                        )
