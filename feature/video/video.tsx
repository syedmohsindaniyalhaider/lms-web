...
const VideoContainer = (props: any) => {
    ...
    const { isRecieveSharing, isStartedShare, sharedContentDimension } =
    ...
    const { advancedSwitch, toggleAdjustVolume, toggleFarEndCameraControl } =
        useAdvancedFeatureSwitch(zmClient, mediaStream)
    ...
    return (
        <div className='viewport'>
            ...
            {isInControl && (
                <RemoteControlIndication stopCameraControl={stopControl} />
            )}
            {totalPage > 1 && (
                <Pagination
                    page={page}
