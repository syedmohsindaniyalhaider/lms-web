...
const SubsessionCreate = (props: SubsessionCreateProps) => {
    ...
    const [pattern, setPattern] = useState<SubsessionAllocationPattern>(
    ...
    return (
        <div className='room-create'>
            ...
            <Radio.Group
                ...
                className='room-create-option'
            >
                <Radio
                    value={SubsessionAllocationPattern.Automatically}
                    key={SubsessionAllocationPattern.Automatically}
                >
                    Assign automatically
                </Radio>
                <Radio
                    value={SubsessionAllocationPattern.Manually}
                    key={SubsessionAllocationPattern.Manually}
                >
                    Assign manually
                </Radio>
            </Radio.Group>
            <div className='room-create-footer'>
                ...
                {pattern === SubsessionAllocationPattern.Automatically && (
                    <span className='room-create-tip'>
                        {subsessionSize} participants per subsession
                    </span>
                )}
            </div>
        </div>
