...
const SubsessionManage = (props: SubsessionManageProps) => {
    ...
    const onBroadcastPopoverVisibleChange = useCallback((visible: any) => {
        ...
        <div className='room-manage'>
            <div className='room-list-wrap'>
                <Collapse className='room-list' ghost>
                    {subsessionStatus !== SubsessionStatus.Closing &&
                        unassignedUserList.length > 0 && (
                            <Panel
                                key='unassigned'
                                header='unassigned'
                                extra={unassignedUserList.length}
                            >
                                <SubsessionItem
                    ...
                    {subsessions.map((subsession) => {
                        const { subsessionName, userList, subsessionId } =
                            subsession
                        return (
                            <Panel
                                key={subsessionName}
            ...
            closingCountdown >= 0 ? (
                <div className='room-closing-coutdown'>
                    <p className='room-closing-coutdown-tip'>
                        All subsessions will close in {closingCountdown}{' '}
                        seconds.
                    </p>
                    {userStatus === SubsessionUserStatus.InSubsession && (
                        <>
                            ...
                            <Button
                                className='room-closing-countdown-leave-btn'
                                onClick={onLeaveSubsessionClick}
                                type='default'
                            >
                                Leave Subsession
                            </Button>
                ...
                <div className='room-actions'>
                    {(subsessionStatus === SubsessionStatus.NotStarted ||
                        ...
                        <Popover
                            ...
                            trigger='click'
                            content={
                                <SubsessionOptions {...subsessionOptions} />
                            }
                        >
                            <Button
                                type='primary'
                    ...
                    <div className='room-actions-list'>
                        {subsessionStatus === SubsessionStatus.InProgress ? (
                            <>
                                <Popover
                                    ...
                                    content={
                                        <BroadcastPanel
                                            afterBroadcast={
                                                closeBroadcastPopover
                                            }
                                        />
                                    }
                                    onVisibleChange={
                                        onBroadcastPopoverVisibleChange
                                    }
                                ...
                                <Button
                                    onClick={onCloseSubsessionsClick}
                                    danger
                                >
                            ...
                            <>
                                ...
                                <Button onClick={onAddSubsession}>
                                    Add a Subsession
                                </Button>
                                <Button
                                    onClick={onOpenSubsessions}
                                    type='primary'
                                >
