...
const SubsessionItem = (props: SubsessionProps) => {
        ...
        onDom: (content: {
            ...
            if (subsessionId) {
                if (
                    ...
                    content.subsessionId !== subsessionId
                ) {
                    onMoveUserToSubsession(
                        content.userId,
                        subsessionId,
    ...
    return (
        <ul
            className={classNames('room-item', { 'drop-over': isHover })}
            {...dropProps}
        >
            {users.map((item) => {
                const dragProps =
                ...
                return (
                    ...
                    >
                        ...
                        {item.avatar ? (
                            <img
                                className='room-item-user-avatar'
                                src={item.avatar}
                                alt=''
                            />
                        ) : (
                            <span
                                className={classNames(
                                    ...
                                    `avatar${getDisplayAvatarColorTag(
                                        item.displayName
                                    )}`
                                )}
                            >
                        ...
                        <span className='room-item-user-name'>
                            {item.displayName}
                        </span>
                    </li>
                )
